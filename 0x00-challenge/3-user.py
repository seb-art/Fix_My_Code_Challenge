...
if __name__ == '__main__':
    ...
    user_2.password = "89"  # changed from 89 to "89" to ensure it's a string
    if user_2.password is not None:
    ...
    if user_1.is_valid_password(89):  # changed from 89 to "89" to ensure it's a string
        print("is_valid_password should return False if compared with a non-string value")
